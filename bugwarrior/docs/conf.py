...
project = 'Bugwarrior'
copyright = '2022, Ralph Bean and contributors'
...
# built documents.
version = release = importlib.metadata.version('bugwarrior')
...
latex_documents = [
    ('index', 'Bugwarrior.tex', 'Bugwarrior Documentation', 'Ralph Bean', 'manual')
]
...
man_pages = [
    (
        'manpage',
        'bugwarrior',
        'update your local taskwarrior database from your forge issue trackers',
        docs_authors,
        1,
    )
]
...
nitpick_ignore = [
    ('py:class', 'ConfigDict'),
    ('py:class', 'Task'),
    ('py:class', 'bugwarrior.collect.CollectedIssue'),
]
